    ...
    return {
        projects: [
            // Projekt 1: Bytovka s 6 poschodiami
            {
                ...
                badge: 'A',
                floors: [
                    { id: 'floor-1', name: '1. poschodie', type: 'Byty 2+kk', label: '1. NP', area: '629.00 m²' },
                    { id: 'floor-2', name: '2. poschodie', type: 'Byty 3+kk', label: '2. NP', area: '578.00 m²' },
                    { id: 'floor-3', name: '3. poschodie', type: 'Byty 3+kk', label: '3. NP', area: '722.00 m²' },
                    { id: 'floor-4', name: '4. poschodie', type: 'Byty 4+kk', label: '4. NP', area: '708.00 m²' },
                    { id: 'floor-5', name: '5. poschodie', type: 'Penthousy', label: '5. NP', area: '616.00 m²' },
                    { id: 'floor-6', name: 'Suterén', type: 'Parkovanie', label: '1. PP', area: '658.00 m²' },
                ],
            },
            // Projekt 2: Obchodné centrum s 3 podlažiami
            {
                ...
                badge: 'B',
                floors: [
                    { id: 'floor-7', name: 'Prízemie', type: 'Retail', label: 'Prízemie', area: '1245.00 m²' },
                    { id: 'floor-8', name: '1. poschodie', type: 'Food court', label: '1. NP', area: '892.00 m²' },
                    { id: 'floor-9', name: 'Parkovisko', type: 'Parkovacie miesta', label: '1. PP', area: '1580.00 m²' },
                ],
            },
            // Projekt 3: Kancelárska budova s 8 podlažiami
            {
                ...
                floors: [
                    ...
                    { id: 'floor-11', name: '1. - 3. poschodie', type: 'Open space', label: '1-3 NP', area: '1890.00 m²' },
                    { id: 'floor-12', name: '4. - 6. poschodie', type: 'Kancelárie', label: '4-6 NP', area: '1756.00 m²' },
                    { id: 'floor-13', name: '7. poschodie', type: 'Meeting rooms', label: '7. NP', area: '612.00 m²' },
                    { id: 'floor-14', name: '8. poschodie', type: 'Executive floor', label: '8. NP', area: '598.00 m²' },
                    { id: 'floor-15', name: 'Strecha', type: 'Terasa', label: 'Strecha', area: '340.00 m²' },
                    { id: 'floor-16', name: 'Suterén -1', type: 'Technické priestory', label: '1. PP', area: '520.00 m²' },
                    { id: 'floor-17', name: 'Suterén -2', type: 'Parkovanie', label: '2. PP', area: '980.00 m²' },
                ],
            },
            ...
            // Projekt 5: Vila s bazénom (malý projekt s 2 podlažiami)
            {
                ...
                badge: 'E',
                floors: [
                    { id: 'floor-18', name: 'Prízemie + terasa', type: 'Obývacia časť', label: 'Prízemie', area: '285.00 m²' },
